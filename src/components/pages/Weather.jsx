...
const Api_key = procss.env.REACT_APP_VERY_PRIVATE_KEY;
...
const Weather = () => {
  ...
  return (
    <div className="bg-indigo-600 h-screen grid place-items-center">
      <div className="bg-white w-96 p-4 rounded-md sm: w-auto sm:h-auto">
